...
// added roving tab index to scroll through each item by pressing up and down keys on keyboard
// it goes through each item and sets the tabIndex accordingly.
      if(item === newMenuitem){
        item.tabIndex = 0;
        newMenuitem.focus();
      }
